            ...
            <div class="reservas-inicio">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="form-periodo">
                            ...
                            <br>
                            <button type="button" onclick="generarPDFPeriodo($('#select-periodo').val())" class="btn btn-outline-danger">Generar
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <table id="tablaReportes" class="table table-striped table-bordered" id="reporte">
